var game = function(){
	...
	this.init = function(){
		...
		this.canvas.width  = 1280; // chiều rộng game
		this.canvas.height = 687; // chiều cao game
		...
		this.chickens = [
			...
			new chicken(this, 850, 25),
			new chicken(this, 950, 25),
			new chicken(this, 1050, 25),
			new chicken(this, 1150, 25),
		];

		this.bowl = new bowl(this);
		this.bowl.init();

		setInterval(self.createNewEgg, 999);
	...
	this.drawLoading = function(){
		...
		self.context.fillText('Loading...', 430, 350);
	}
